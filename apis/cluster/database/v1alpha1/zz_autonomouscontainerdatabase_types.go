...
type AutonomousContainerDatabaseInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	SourceAutonomousContainerDatabaseIDRef *v1.Reference `json:"sourceAutonomousContainerDatabaseIdRef,omitempty" tf:"-"`

	// Selector for a AutonomousContainerDatabase in database to populate sourceAutonomousContainerDatabaseId.
	// +kubebuilder:validation:Optional
	SourceAutonomousContainerDatabaseIDSelector *v1.Selector `json:"sourceAutonomousContainerDatabaseIdSelector,omitempty" tf:"-"`
