...
func (in *ConfigurationsInitParameters) DeepCopyInto(out *ConfigurationsInitParameters) {
	*out = *in
	...
	if in.QuickRecycleSettings != nil {
		in, out := &in.QuickRecycleSettings, &out.QuickRecycleSettings
		*out = make([]QuickRecycleSettingsInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ConfigurationsObservation) DeepCopyInto(out *ConfigurationsObservation) {
	*out = *in
	...
	if in.QuickRecycleSettings != nil {
		in, out := &in.QuickRecycleSettings, &out.QuickRecycleSettings
		*out = make([]QuickRecycleSettingsObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ConfigurationsParameters) DeepCopyInto(out *ConfigurationsParameters) {
	*out = *in
	...
	if in.QuickRecycleSettings != nil {
		in, out := &in.QuickRecycleSettings, &out.QuickRecycleSettings
		*out = make([]QuickRecycleSettingsParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *QuickRecycleSettingsInitParameters) DeepCopyInto(out *QuickRecycleSettingsInitParameters) {
	*out = *in
	if in.NvmeWipe != nil {
		in, out := &in.NvmeWipe, &out.NvmeWipe
		*out = new(bool)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new QuickRecycleSettingsInitParameters.
func (in *QuickRecycleSettingsInitParameters) DeepCopy() *QuickRecycleSettingsInitParameters {
	if in == nil {
		return nil
	}
	out := new(QuickRecycleSettingsInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *QuickRecycleSettingsObservation) DeepCopyInto(out *QuickRecycleSettingsObservation) {
	*out = *in
	if in.NvmeWipe != nil {
		in, out := &in.NvmeWipe, &out.NvmeWipe
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new QuickRecycleSettingsObservation.
func (in *QuickRecycleSettingsObservation) DeepCopy() *QuickRecycleSettingsObservation {
	if in == nil {
		return nil
	}
	out := new(QuickRecycleSettingsObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *QuickRecycleSettingsParameters) DeepCopyInto(out *QuickRecycleSettingsParameters) {
	*out = *in
	if in.NvmeWipe != nil {
		in, out := &in.NvmeWipe, &out.NvmeWipe
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new QuickRecycleSettingsParameters.
func (in *QuickRecycleSettingsParameters) DeepCopy() *QuickRecycleSettingsParameters {
	if in == nil {
		return nil
	}
	out := new(QuickRecycleSettingsParameters)
	in.DeepCopyInto(out)
	return out
}
