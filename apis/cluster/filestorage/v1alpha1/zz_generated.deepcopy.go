...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LockDurationDetailsInitParameters) DeepCopyInto(out *LockDurationDetailsInitParameters) {
	*out = *in
	if in.CoolOffDuration != nil {
		in, out := &in.CoolOffDuration, &out.CoolOffDuration
		*out = new(float64)
		**out = **in
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LockDurationDetailsInitParameters.
func (in *LockDurationDetailsInitParameters) DeepCopy() *LockDurationDetailsInitParameters {
	if in == nil {
		return nil
	}
	out := new(LockDurationDetailsInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LockDurationDetailsObservation) DeepCopyInto(out *LockDurationDetailsObservation) {
	*out = *in
	if in.CoolOffDuration != nil {
		in, out := &in.CoolOffDuration, &out.CoolOffDuration
		*out = new(float64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LockDurationDetailsObservation.
func (in *LockDurationDetailsObservation) DeepCopy() *LockDurationDetailsObservation {
	if in == nil {
		return nil
	}
	out := new(LockDurationDetailsObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LockDurationDetailsParameters) DeepCopyInto(out *LockDurationDetailsParameters) {
	*out = *in
	if in.CoolOffDuration != nil {
		in, out := &in.CoolOffDuration, &out.CoolOffDuration
		*out = new(float64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LockDurationDetailsParameters.
func (in *LockDurationDetailsParameters) DeepCopy() *LockDurationDetailsParameters {
	if in == nil {
		return nil
	}
	out := new(LockDurationDetailsParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OutboundConnectorInitParameters) DeepCopyInto(out *OutboundConnectorInitParameters) {
	*out = *in
	...
	if in.TrustedCertificateSecretID != nil {
		in, out := &in.TrustedCertificateSecretID, &out.TrustedCertificateSecretID
		*out = new(string)
		**out = **in
	}
	if in.TrustedCertificateSecretIDRef != nil {
		in, out := &in.TrustedCertificateSecretIDRef, &out.TrustedCertificateSecretIDRef
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.TrustedCertificateSecretIDSelector != nil {
		in, out := &in.TrustedCertificateSecretIDSelector, &out.TrustedCertificateSecretIDSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
	if in.TrustedCertificateSecretVersion != nil {
		in, out := &in.TrustedCertificateSecretVersion, &out.TrustedCertificateSecretVersion
		*out = new(float64)
		**out = **in
	}
}
...
func (in *SchedulesInitParameters) DeepCopyInto(out *SchedulesInitParameters) {
	*out = *in
	...
	if in.LockDurationDetails != nil {
		in, out := &in.LockDurationDetails, &out.LockDurationDetails
		*out = make([]LockDurationDetailsInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SchedulesObservation) DeepCopyInto(out *SchedulesObservation) {
	*out = *in
	...
	if in.LockDurationDetails != nil {
		in, out := &in.LockDurationDetails, &out.LockDurationDetails
		*out = make([]LockDurationDetailsObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SchedulesParameters) DeepCopyInto(out *SchedulesParameters) {
	*out = *in
	...
	if in.LockDurationDetails != nil {
		in, out := &in.LockDurationDetails, &out.LockDurationDetails
		*out = make([]LockDurationDetailsParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SnapshotInitParameters) DeepCopyInto(out *SnapshotInitParameters) {
	*out = *in
	...
	if in.LockDurationDetails != nil {
		in, out := &in.LockDurationDetails, &out.LockDurationDetails
		*out = make([]SnapshotLockDurationDetailsInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SnapshotLockDurationDetailsInitParameters) DeepCopyInto(out *SnapshotLockDurationDetailsInitParameters) {
	*out = *in
	if in.CoolOffDuration != nil {
		in, out := &in.CoolOffDuration, &out.CoolOffDuration
		*out = new(float64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SnapshotLockDurationDetailsInitParameters.
func (in *SnapshotLockDurationDetailsInitParameters) DeepCopy() *SnapshotLockDurationDetailsInitParameters {
	if in == nil {
		return nil
	}
	out := new(SnapshotLockDurationDetailsInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SnapshotLockDurationDetailsObservation) DeepCopyInto(out *SnapshotLockDurationDetailsObservation) {
	*out = *in
	if in.CoolOffDuration != nil {
		in, out := &in.CoolOffDuration, &out.CoolOffDuration
		*out = new(float64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SnapshotLockDurationDetailsObservation.
func (in *SnapshotLockDurationDetailsObservation) DeepCopy() *SnapshotLockDurationDetailsObservation {
	if in == nil {
		return nil
	}
	out := new(SnapshotLockDurationDetailsObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SnapshotLockDurationDetailsParameters) DeepCopyInto(out *SnapshotLockDurationDetailsParameters) {
	*out = *in
	if in.CoolOffDuration != nil {
		in, out := &in.CoolOffDuration, &out.CoolOffDuration
		*out = new(float64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SnapshotLockDurationDetailsParameters.
func (in *SnapshotLockDurationDetailsParameters) DeepCopy() *SnapshotLockDurationDetailsParameters {
	if in == nil {
		return nil
	}
	out := new(SnapshotLockDurationDetailsParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SnapshotObservation) DeepCopyInto(out *SnapshotObservation) {
	*out = *in
	...
	if in.LockDurationDetails != nil {
		in, out := &in.LockDurationDetails, &out.LockDurationDetails
		*out = make([]SnapshotLockDurationDetailsObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.TimeLocked != nil {
		in, out := &in.TimeLocked, &out.TimeLocked
		*out = new(string)
		**out = **in
	}
}
...
func (in *SnapshotParameters) DeepCopyInto(out *SnapshotParameters) {
	*out = *in
	...
	if in.LockDurationDetails != nil {
		in, out := &in.LockDurationDetails, &out.LockDurationDetails
		*out = make([]SnapshotLockDurationDetailsParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
